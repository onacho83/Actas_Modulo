                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                            <div class="panel-heading">Editar Fecha seleccionada</div>
                            ...
                            <form method="post" action="{{ url('/admin/fecha_Finales/'.$fecha_Final ->id.'/edit') }} ">
                              ...
                              <button class="btn btn-success">Actualizar Fecha</button>
                               
                            <a class="btn btn-success" href="{{ url('/admin/fecha_Finales/') }} "> Cancelar</a>
                            </form>
